...
public class Command_FakeOp implements CommandExecutor
{
	...
	public boolean onCommand(CommandSender arg0, Command arg1, String arg2, String[] arg3) 
	{
		...
		if(arg0 instanceof Player)
		{
			...
			if(playerSender.hasPermission("fake.fakeop") || playerSender.isOp())
			{
				if(arg3.length == 0)
				{
					playerSender.sendMessage("§cError. Usage: /Fakeop <Username>");
				}
				else
				{
					...
					else
					{
						...
						playerSender.sendMessage(String.format("§7Player '%s' has been fake-opped.", arg3[0]));
						playerTarget.sendMessage("§eYou are now OP!");
					}
				}
			}
			else
